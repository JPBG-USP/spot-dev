...
class PoseBodyActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = PoseBodyGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new PoseBodyActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = PoseBodyGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new PoseBodyGoal()
    }
...
module.exports = PoseBodyActionGoal;
