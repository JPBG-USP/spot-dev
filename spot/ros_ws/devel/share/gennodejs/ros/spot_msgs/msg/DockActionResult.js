...
class DockActionResult {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = DockResult.serialize(obj.result, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += DockResult.getMessageSize(object.result);
    return length;
  }

  static datatype() {
    // Returns string type for a message object
    return 'spot_msgs/DockActionResult';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new DockActionResult(null);
    ...
    if (msg.result !== undefined) {
      resolved.result = DockResult.Resolve(msg.result)
    }
    else {
      resolved.result = new DockResult()
    }
...
module.exports = DockActionResult;
